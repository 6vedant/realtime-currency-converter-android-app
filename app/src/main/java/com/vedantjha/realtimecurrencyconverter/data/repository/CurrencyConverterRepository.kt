...
class CurrencyConverterRepository @Inject constructor(val currencyConverterApiService: CurrencyConverterApiService) {
   ...
   suspend fun getAllAvailableCurrenciesLocalDatabase() = currencyConverterDao.getAllCurrencies()
