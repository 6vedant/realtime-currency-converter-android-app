...
class CurrencyConverterRepository @Inject constructor(private val currencyConverterApiService: CurrencyConverterApiService, private val currencyConverterDao: CurrencyConverterDao ) {
    ...
    fun getAllAvailableCurrenciesLocalDatabase() = currencyConverterDao.getAllCurrencies()
